...
//         //     printf("New message received, data[%d]=%02x ", j, s_can_rx_buf.data[j]);
//         // }
//         // printf("size of s_can_rx_buf = %d bytes\n", sizeof(s_can_rx_buf));
//         // printf("\n");
//     }
// }
...
void show_help(void)
{
    static const char help_info[] = ""
                                    ...
                                    "*********************************************************************************\n";
    printf("%s\n", help_info);
    printf("size of  can_transmit_buf_t = %d bytes\n",sizeof(can_transmit_buf_t));
    printf("size of  can_receive_buf_t = %d bytes\n",sizeof(can_receive_buf_t));
